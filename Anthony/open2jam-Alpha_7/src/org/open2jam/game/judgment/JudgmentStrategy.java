...
public interface JudgmentStrategy {
    ...
    /**
     * Must be called after decideRandomMiss, returns true if the note
     * is to be judged normally, returns false if the note will be forced
     * to be a miss.
     * @return the random miss result
     */
