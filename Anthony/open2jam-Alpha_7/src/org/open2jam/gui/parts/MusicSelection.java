...
public class MusicSelection extends javax.swing.JPanel
    ...
    private class RenderThread extends Thread {
        ...
        public void run() {
            c.setEnabled(false);
            rr.startMusic();
            r.setComboOverride(enable_combo);
            r.startRendering();
            c.setEnabled(true);
            int total_notes = r.getTotalNotes();
            if(total_notes == 0){
                total_notes = 1;
            }
            int num_missed = r.getNumMissed();
            prev_error_display.setText(String.valueOf(num_missed));
            prev_error_rate_display.setText(String.valueOf((float)num_missed/total_notes * 100));
            prev_max_combo_display.setText(String.valueOf(r.getMaxCombo()));
            err_indicator.setText(String.valueOf(r.containsForcedMiss()));
        }
    }
    ...
    private void initComponents() {
        ...
        prev_error_rate = new javax.swing.JLabel();
        prev_error = new javax.swing.JLabel();
        prev_error_display = new javax.swing.JLabel();
        prev_error_rate_display = new javax.swing.JLabel();
        prev_max_combo = new javax.swing.JLabel();
        prev_max_combo_display = new javax.swing.JLabel();
        ...
        autoplay_directory = new javax.swing.JButton();
        printAvgNoteRates = new javax.swing.JButton();
        err_indicator_label = new javax.swing.JLabel();
        err_indicator = new javax.swing.JLabel();
        prev_error_toggle = new javax.swing.JCheckBox();
        combo_label = new javax.swing.JLabel();
        combo_button = new javax.swing.JCheckBox();
        ...
        prev_error_rate.setText("Previous Error Rate:");

        prev_error.setText("Previous Errors:");
        prev_error.setToolTipText("");

        prev_error_display.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        prev_error_display.setText("0");

        prev_error_rate_display.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        prev_error_rate_display.setText("0");

        prev_max_combo.setText("Previous Max Combo:");
        prev_max_combo.setToolTipText("");

        prev_max_combo_display.setText("0");
                    ...
                    .addGroup(panel_settingLayout.createSequentialGroup()
                        ...
                        .addGroup(panel_settingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panel_settingLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(prev_error_rate)
                                .addGap(18, 18, 18)
                                .addComponent(prev_error_rate_display, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(panel_settingLayout.createSequentialGroup()
                                .addComponent(cb_autoSyncDisplay)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panel_settingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(panel_settingLayout.createSequentialGroup()
                                        .addComponent(prev_max_combo)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(prev_max_combo_display, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))
                                    .addGroup(panel_settingLayout.createSequentialGroup()
                                        .addComponent(prev_error)
                                        .addGap(43, 43, 43)
                                        .addComponent(prev_error_display, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                        .addContainerGap())
                    .addGroup(panel_settingLayout.createSequentialGroup()
                        .addGap(58, 58, 58)
        ...
        panel_settingLayout.setVerticalGroup(
            ...
            .addGroup(panel_settingLayout.createSequentialGroup()
                ...
                .addGroup(panel_settingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(prev_max_combo)
                    .addComponent(prev_max_combo_display))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_settingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    ...
                    .addComponent(cb_autoSyncDisplay)
                    .addComponent(prev_error)
                    .addComponent(prev_error_display))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_settingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    ...
                    .addComponent(cb_autoSyncAudio)
                    .addComponent(prev_error_rate)
                    .addComponent(prev_error_rate_display)))
        );

        prev_error.getAccessibleContext().setAccessibleName("prev_error");
        ...
        panel_listLayout.setVerticalGroup(
            ...
            .addGroup(panel_listLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(table_scroll, javax.swing.GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_listLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        autoplay_directory.setText("Autoplay Directory");
        autoplay_directory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                autoplay_directoryActionPerformed(evt);
            }
        });

        printAvgNoteRates.setText("Print Average Note Rates");
        printAvgNoteRates.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                printAvgNoteRatesActionPerformed(evt);
            }
        });

        err_indicator_label.setText("Indicator:");

        err_indicator.setText("false");

        prev_error_toggle.setText("Previous Error Hidden");
        prev_error_toggle.setToolTipText("");
        prev_error_toggle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                prev_error_toggleActionPerformed(evt);
            }
        });

        combo_label.setText("Combo:");

        combo_button.setText("Enabled");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(57, 57, 57)
                        .addComponent(printAvgNoteRates)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(autoplay_directory)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(prev_error_toggle)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(err_indicator_label)
                                        .addGap(18, 18, 18)
                                        .addComponent(err_indicator)))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(combo_label)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(combo_button)
                        .addGap(4, 4, 4))))
        );
    ...
    private Render initRender(){
        ...
        try {
            ...
            double hispeed = (Double) js_hispeed.getValue();
            ...
            boolean vsync = jc_vsync.isSelected();
            ...
            boolean autoplay = jc_autoplay.isSelected();
            boolean autosound = jc_autosound.isSelected();

            boolean time_judgment = jc_timed_judgment.isSelected();

            SpeedType speed_type =(SpeedType) combo_speedType.getSelectedItem();

            ChannelMod channelModifier = (ChannelMod) combo_channelModifier.getSelectedItem();
            VisibilityMod visibilityModifier = (VisibilityMod) combo_visibilityModifier.getSelectedItem();

            float mainVol = slider_main_vol.getValue() / 100f;
            float keyVol = slider_key_vol.getValue() / 100f;
            float bgmVol = slider_bgm_vol.getValue() / 100f;
            ...
            writer.println(selected_header.getTitle() + "," + rank);
    ...
    private void autoplay_directoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_autoplay_directoryActionPerformed
        int i = selected_row;
        while(i < model_songlist.getRowCount()){
            for (int newRank = 1; newRank <= 2; newRank++){
                setRank(newRank);
                System.out.println("Playing the " +i+"th song with rank " + rank + ".");
                selected_chart = model_songlist.getRow(i);
                selected_header = selected_chart.get(rank);
                updateChartSelectionFromRank();
                updateInfo();
                Render r = initRender();
                Render rr = initRender();
                Thread thread = new RenderThread(this.getTopLevelAncestor(), r, rr);
                thread.start();
                try{
                    thread.join();
    ...
    }//GEN-LAST:event_autoplay_directoryActionPerformed

    private void printAvgNoteRatesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printAvgNoteRatesActionPerformed
        int i = 0;
        while(i < model_songlist.getRowCount()){
            for (int newRank = 0; newRank <= 2; newRank++){
                setRank(newRank);
                selected_chart = model_songlist.getRow(i);
                selected_header = selected_chart.get(rank);
                updateChartSelectionFromRank();
                updateInfo();
                int notes = selected_header.getNoteCount();
                int time = selected_header.getDuration();
                if (notes > 0){
                    String info = "Average Note Rate: " + (float)notes/time;
                    info += " Song Name: " + selected_header.getCoverName();
                    info += " Rank: " + newRank;
                    info += " Notes: " + notes;
                    info += " Duration: " + time;
    ...
    }//GEN-LAST:event_printAvgNoteRatesActionPerformed

    private void prev_error_toggleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prev_error_toggleActionPerformed
        boolean show = !prev_error_toggle.isSelected();
        prev_error_display.setVisible(show);
        prev_error.setVisible(show);
        prev_error_rate_display.setVisible(show);
        prev_error_rate.setVisible(show);
    }//GEN-LAST:event_prev_error_toggleActionPerformed

    private void combo_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_buttonActionPerformed
        boolean enabled = combo_button.isSelected();
        enable_combo = enabled;
    }//GEN-LAST:event_combo_buttonActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton autoplay_directory;
    ...
    private javax.swing.JCheckBox combo_button;
    ...
    private javax.swing.JLabel err_indicator;
    private javax.swing.JLabel err_indicator_label;
    ...
    private javax.swing.JLabel prev_error;
    private javax.swing.JLabel prev_error_display;
    private javax.swing.JLabel prev_error_rate;
    private javax.swing.JLabel prev_error_rate_display;
    private javax.swing.JCheckBox prev_error_toggle;
    private javax.swing.JLabel prev_max_combo;
    private javax.swing.JLabel prev_max_combo_display;
    private javax.swing.JButton printAvgNoteRates;
